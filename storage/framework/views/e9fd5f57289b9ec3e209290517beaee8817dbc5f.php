<div class="modal fade" id="formDoctorModal" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <form id="doctorForm" action="<?php echo e(route('savedoctor')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control show-tick" id="roomid" name="roomid" required>
                                                ...
                                                <?php foreach($rooms as $room): ?> <option value="<?php echo e($room->id); ?>"><?php echo e($room->name); ?></option> <?php endforeach; ?>
                                            ...
                                            <select class="form-control show-tick" id="specialtyid" name="specialtyid" required>
                                                ...
                                                <?php if(count($specialtys)>0): ?>

                                                <?php foreach($specialtys as $specialty): ?> <option value="<?php echo e($specialty->id); ?>"><?php echo e($specialty->name); ?></option> <?php endforeach; ?>
