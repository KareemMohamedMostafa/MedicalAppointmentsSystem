                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group"> <textarea id="address" name="address" rows="3" class="form-control" placeholder="Enter address"></textarea> </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control show-tick" id="doctorid" name="doctorid" required style="height: 100px; overflow-y:scroll;">
